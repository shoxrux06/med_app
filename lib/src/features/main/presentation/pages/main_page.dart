...
import 'package:medical_app/src/features/monitoring/presentation/pages/monitoring_page.dart';
...
class _MainPageState extends State<MainPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body:_selectedIndex == 4? _widgetOptions[0]:_widgetOptions[_selectedIndex] ,
